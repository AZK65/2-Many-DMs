        ...
        <div className="mx-auto max-w-2xl px-5 py-6">
          <div className="mb-5 flex items-center justify-between">
            ...
            <motion.button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-accent px-3.5 py-2 text-sm font-medium text-accent-fg transition hover:bg-accent"
            >
          ...
          {!loading && autos.length === 0 && (
            <div className="rounded-2xl border border-dashed border-slate-200 py-16 text-center dark:border-neutral-800">
              <div className="mx-auto mb-3 grid h-11 w-11 place-items-center rounded-xl bg-accent/15 text-accent dark:bg-accent/15 dark:text-accent">
        ...
        <div className="scroll-thin grid flex-1 grid-cols-2 gap-2.5 overflow-y-auto p-4">
          {TEMPLATES.map((t) => (
            <button
              ...
              className="rounded-xl border border-slate-200 p-3 text-left transition hover:border-accent/50 hover:bg-accent/40 dark:border-neutral-800 dark:hover:border-accent/40 dark:hover:bg-accent/5"
            >
              <div className="flex items-center gap-2">
                <span className="grid h-6 w-6 place-items-center rounded-md bg-accent/15 text-accent dark:bg-accent/15 dark:text-accent">
        ...
        <div className="scroll-thin flex-1 space-y-4 overflow-y-auto p-5">
              ...
              const meta =
                a.type === "send"
                  ? {
                      ...
                      chip: "bg-accent/15 text-accent dark:bg-accent/15 dark:text-accent",
                    }
                  : a.type === "tag"
                  ? {
                      label: "Add tag",
          ...
          <div className="rounded-xl border border-slate-200 dark:border-neutral-800">
            <div className="flex items-center justify-between border-b border-slate-100 px-3 py-2 text-xs font-semibold dark:border-neutral-800">
              ...
              <span className="rounded-full bg-accent/15 px-2 py-0.5 text-accent dark:bg-accent/15 dark:text-accent">
...
const inputCls =
  "w-full rounded-lg bg-slate-100 px-3 py-2 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-accent/40 dark:bg-neutral-800 dark:text-neutral-100 dark:placeholder:text-neutral-500 dark:focus:bg-neutral-800 dark:focus:ring-accent/40";
